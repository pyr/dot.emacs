...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (powerline yaml-mode web-mode smex smartparens rust-mode rainbow-delimiters puppet-mode projectile paredit markdown-mode magit lua-mode gruvbox-theme go-mode gist flymake-python-pyflakes flx-ido company cider ag)))
